    ...
    <div className="min-h-screen flex items-center justify-center bg-navy-950 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            <h1 className="font-display text-2xl font-bold text-navy-900 tracking-tight">Welcome back</h1>
            <p className="mt-1 text-sm text-navy-600/60">Sign in to your account</p>
            ...
            <form onSubmit={handleSubmit} className="mt-7 space-y-5">
              ...
              <div className="flex justify-end -mt-1">
                <Link to="/forgot-password" className="text-xs font-medium text-gold-600 hover:text-gold-500 transition-colors">
                  Forgot password?
                </Link>
              </div>
