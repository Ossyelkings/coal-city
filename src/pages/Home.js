    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at top right, #d4a853, transparent 60%)',
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Hero visual — luxe image composition */}
            ...
            <div className="relative w-full aspect-[4/5] max-w-md ml-auto">
              ...
              <div className="absolute inset-4 rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div
                  className="absolute inset-0 opacity-30"
                  style={{
                    background: 'linear-gradient(180deg, transparent 30%, rgba(212, 168, 83, 0.15) 100%)',
                  }}
                />
              </div>
              {/* Floating accent card */}
              <div className="absolute -bottom-4 -left-4 w-40 h-24 rounded-2xl bg-gradient-to-br from-gold-500 to-gold-600 shadow-xl shadow-gold-500/20 flex items-center justify-center p-4 animate-fade-in-up delay-500">
      ...
      <section className="relative py-28 bg-cream-50">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-bold text-navy-900 mt-3 tracking-tight">
              Our Product Range
            </h2>
            ...
            {categories.map((cat, i) => (
              ...
              >
                ...
                <div className="h-52 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 right-4 text-white/20 text-4xl font-display">
                    {cat.icon}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <p className="mt-1 text-sm text-navy-600/60">{cat.desc}</p>
      ...
      <section className="relative py-28 bg-navy-900 overflow-hidden">
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 50% 60% at 80% 50%, #1e3a5f, transparent)',
          }}
        />
